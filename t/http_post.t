...
=== TEST HTTP_POST_6: POST with 2 valid cookies and a CSRF token returns 200 for the same domain
#############################################################################################
# Verify that POSTs with cookies work OK in same domain setups, when no origin header is sent
#############################################################################################
